  ...
  sections: {
      ...
      content: [
        {
          ...
          content: 'Au cours de mes années d\'études et sur différents projets professionnels, j\'ai appris à maîtriser plusieurs langages de front-end HTML, CSS, JavaScript et framework tel que BootStrap et JQuery. De plus, j\'ai été formé au back-end avec PHP, MySQL tout en optimisant le référencement (SEO).',
          circles: [
            {
              title: 'HTML/CSS',
              style: 'nopeQCB',
        ...
        {
          title: 'Graphisme',
          content: 'Durant mon parcours, j\'ai dû élargir mon champ de compétences en me formant sur des logiciels professionnels de retouche et de création numérique (suite Adobe).',
          circles: [
            {
              title: 'Photoshop',
              style: 'nopeSB',
      ...
      content: [
        {
          ...
          link: null,
          content: 'Après un Bac technologique dans le monde de l\'environnement, je me suis naturellement tourné vers un BTS GPN dans lequel j\'ai pu acquérir de l\'expérience dans le domaine de l\'écologie et de l\'agronomie.',
        },

        {
          ...
          content: 'Dans le cadre de mon BTS GPN, je suis parti en Lettonie pour réaliser mon stage dans le parc National de Kemeri. J\'y étais "Chargé d\'animaton" (organisateur et animateur) sur différentes activités du parc.',
        },

        {
          title: 'WARNING Conférence International<br>sur la Biodiversité WARNING',
          date: 'Octobre 2015',
          ...
          link: {
            url: 'https://www.ladepeche.fr/article/2015/10/01/2188462-rencontres-internationales-sur-la-biodiversite-et-les-milieux-naturels.html',
            text: 'Article de Ladépêche',
          },
          content: 'Présentation de mes tâches de Chargé d\'animation dans le parc national de Kemeri et de ses atouts en matière de biodiversité.',
        },

        {
          ...
          link: null,
          content: 'Ne me voyant pas poursuivre dans l\'environnement, j\'ai décidé de m\'orienter vers une autre passion qu\'est l\'informatique. J\'ai donc intégré le DUT MMI de Vichy qui est essentiellement spécialisé dans le web et le multimédia.',
        },

        {
          ...
          content: 'Dans le cadre de mon DUT MMI, j\'ai été en charge du poste développeur web accompagné de deux graphistes. Cela dans le but de créer le site web d\'Auvergne Comm\'Unique, entreprise de lettrage publicitaire et impression numérique',
        },

        {
          ...
          content: 'En dernière année de DUT, il m\'a été confié le projet de développer un site web pour l\'entreprise InSport avec l\'aide d\'un développeur Back-end. InSport est une entreprise de coaching sportif pour professionnels et particuliers.',
        },
    ...
    interet: {
      ...
      content: [
        {
          title: 'Informatique',
          content: 'Passionné depuis toujours, j\'ai toujours été attiré a tout ce qui touche l\'informatique et les nouvelles technologi.',
          icon: 'fa-desktop',
        },
        {
          title: 'Voyage',
